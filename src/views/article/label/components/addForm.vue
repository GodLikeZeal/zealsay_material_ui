                        ...
                        <v-layout wrap>
                            ...
                            <v-flex xs6>
                                ...
                                <v-chip :color="form.outColor" text-color="white">
                                    <v-avatar :class="form.avatarColor" v-if="form.icon.startsWith('http')">
                                        <img :src="form.icon" alt="avatar">
                                    </v-avatar>
                                    <v-avatar :class="form.avatarColor" v-else-if="form.icon ===''">
                                ...
                                <v-flex>
                                <p class="font-weight-light text--secondary">图标支持material icons，可以参考<a href="https://material.io/tools/icons">https://material.io/tools/icons</a>
                                    或者 <a href="https://materialdesignicons.com">https://materialdesignicons.com</a></p>
                                    <p class="text--secondary">注意：您只有一次选择图标的机会哦，选错了，后期无法更改！</p>
                                </v-flex>
                            </v-flex>
                        </v-layout>
                    </v-container>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            outColors: [{icon: 'mdi-circle', text: 'red', valueRules: 'red'},
        ...
        methods: {
            ...
            handleSubmit() {
                ...
                if (this.$refs.form.validate()) {
                    addArticleLabel(this.form).then(res => {
                        this.loading = false;
