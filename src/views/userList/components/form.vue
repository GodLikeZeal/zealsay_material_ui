        ...
        <v-container fill-height fluid>
            <v-layout fill-height class="center" >
                <v-flex xs12 align-center flexbox>
                    <a href="#" title="点击修改头像">
                        <vue-initials-img class="avator"  height="64" width="64" :name="row.username" :lazy-src="form.avatar" :src="form.avatar" />
                    </a>
...
import { addUser, editUser,uploadImage,getIsInUseByUsername,getIsInUseByPhone,getIsInUseByEmail } from "@/api/user";
